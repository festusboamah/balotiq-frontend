...
export default function PublicEngageVotePage() {
  ...
  return <main className="mx-auto min-h-screen w-full max-w-3xl px-4 py-10 sm:px-6">
    ...
    {selected && <section className="mt-8 border bg-card p-6">
      ...
      <div className="mt-3 flex items-center gap-3">{selected.photo_url && <img src={resolveSiteImageUrl(selected.photo_url)} alt="" className="h-14 w-14 shrink-0 rounded-full object-cover" />}<h2 className="font-heading text-2xl font-bold">Vote for {selected.name}</h2></div>
