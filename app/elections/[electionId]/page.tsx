...
export default function ElectionPage() {
  ...
  const uploadCandidatePhoto = async (candidateId: string, file: File) => {
    setUploadingPhotoFor(candidateId); setError("");
    try { const body = new FormData(); body.append("file", file); await authPost(`/api/v1/candidates/${candidateId}/photo`, body); refresh(); }
